...
public class AdapterRecommendCar extends ArrayAdapter<Car> {
    ...
    public AdapterRecommendCar(Context context, ArrayList<Car> car) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (position == 1) {
            imageViewTop.setImageResource(R.drawable.top2);
        }
        if (position == 2) {
            imageViewTop.setImageResource(R.drawable.top3);
        }
        if (position == 3) {
